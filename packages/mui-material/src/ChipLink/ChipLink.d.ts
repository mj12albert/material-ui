...
export type ChipLinkProps = ChipLinkOwnProps &
  Omit<React.ComponentPropsWithoutRef<'a'>, 'children' | 'color' | 'href'>;
 ...
 * native disabled state for `<a>` elements.
 *
 * Demos:
 *
 ...
 */
declare const ChipLink: React.ForwardRefExoticComponent<
  ChipLinkProps & React.RefAttributes<HTMLDivElement>
>;
